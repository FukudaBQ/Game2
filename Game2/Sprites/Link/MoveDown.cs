...
namespace Game2.Sprites.Link
{
    public class MoveDown : ISprite
    {
        ...
        public MoveDown(Texture2D texture, Vector2 location, SpriteBatch batch, GraphicsDeviceManager graphics)
        {
        ...
        public void Draw()
        {
            Rectangle sourceRectangle = new Rectangle(1 + currentFrame * 30, 0, 15, 25);
